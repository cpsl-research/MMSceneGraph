...
from mmscene.core.export import build_model_from_cfg, preprocess_example_input
from mmscene.core.export.model_wrappers import ONNXRuntimeDetector
...
def pytorch2onnx(model,
    ...
    if do_simplify:
        ...
        from mmscene import digit_version
