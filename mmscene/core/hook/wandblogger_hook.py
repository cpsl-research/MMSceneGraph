...
from mmscene.core import DistEvalHook, EvalHook
from mmscene.core.mask.structures import polygon_to_bitmap
...
class MMDetWandbHook(WandbLoggerHook):
    ...
    def _add_ground_truth(self, runner):
        ...
        from mmscene.datasets.pipelines import LoadImageFromFile
        img_loader = None
