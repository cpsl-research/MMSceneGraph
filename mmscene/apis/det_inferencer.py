...
from mmscene.structures.mask import encode_mask_results, mask2bbox
...
class DetInferencer(BaseInferencer):
    ...
    Args:
        ...
        scope (str, optional): The scope of the model. Defaults to mmscene.
    ...
    def _init_pipeline(self, cfg: ConfigType) -> Compose:
        ...
        pipeline_cfg[load_img_idx]['type'] = 'mmscene.InferencerLoader'
