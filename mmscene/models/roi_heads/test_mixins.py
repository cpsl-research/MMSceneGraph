...
from mmscene.models.test_time_augs import merge_aug_bboxes, merge_aug_masks
from mmscene.structures.bbox import bbox2roi, bbox_mapping

if sys.version_info >= (3, 7):
    from mmscene.utils.contextmanagers import completed
