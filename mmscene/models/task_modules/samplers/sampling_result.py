...
from mmscene.structures.bbox import BaseBoxes, cat_boxes
from mmscene.utils import util_mixins
from mmscene.utils.util_random import ensure_rng
...
class SamplingResult(util_mixins.NiceRepr):
    ...
    Example:
        ...
        >>> from mmscene.models.task_modules.samplers.sampling_result import *  # NOQA
    ...
    def random(cls, rng=None, **kwargs):
        ...
        from mmscene.models.task_modules.assigners import AssignResult
        from mmscene.models.task_modules.samplers import RandomSampler
        rng = ensure_rng(rng)
