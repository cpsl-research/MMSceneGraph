...
from mmscene.structures.bbox import get_box_type
from mmscene.structures.bbox.box_type import autocast_box_type
...
class InferencerLoader(BaseTransform):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.from_ndarray = TRANSFORMS.build(
            dict(type='mmscene.LoadImageFromNDArray', **kwargs))
