...
def register_box(name: str,
    ...
    Examples:
        >>> from mmscene.structures.bbox import register_box
...
def register_box_converter(src_type: Union[str, type],
    ...
    Examples:
        >>> from mmscene.structures.bbox import register_box_converter
        >>> # as a decorator
...
def autocast_box_type(dst_box_type='hbox') -> Callable:
    ...
    It commenly used in mmscene.datasets.transforms to make the transforms up-
