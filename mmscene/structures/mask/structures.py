...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def get_bboxes(self, dst_type='hbb'):
        ...
        Please refer to ``mmscene.structures.bbox.box_type`` for more details of
        the box type.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from mmscene.data_elements.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from mmscene.data_elements.mask.structures import BitmapMasks
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from mmscene.data_elements.mask.structures import PolygonMasks
