...
from mmscene.models.task_modules.assigners.assign_result import AssignResult
from mmscene.models.task_modules.assigners.max_iou_assigner import MaxIoUAssigner
